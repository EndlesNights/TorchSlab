...
public class BlockWallTorchSlab extends WallTorchBlock
{
	...
	public BlockWallTorchSlab(Block.Properties properties, IParticleData particleType, Character type)
	{
	...
	public void animateTick(BlockState stateIn, World worldIn, BlockPos pos, Random rand)
	{
		...
		worldIn.addParticle(FLAMEPART, d0 + 0.27D * (double)direction1.getXOffset(), d1 + 0.22D, d2 + 0.27D * (double)direction1.getZOffset(), 0.0D, 0.0D, 0.0D);
	   }
