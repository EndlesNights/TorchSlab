package com.endlesnights.torchslabsmod.blocks.quark.entities;

import java.util.List;

import com.endlesnights.torchslabsmod.blocks.quark.BlockCandleSlab;
...
public class FallingCandleSlabEntity extends Entity
{
	            ...
	            if (!this.onGround && !flag1) {
	               ...
	               if (blockstate.getBlock() != Blocks.MOVING_PISTON) {
	                  ...
	                  if (!this.dontSetBlock) {
	                     ...
	                     boolean flag3 = this.fallTile.isValidPosition(this.world, blockpos1) && !BlockCandleSlab.canFallThrough(this.world.getBlockState(blockpos1.down()));
	                     if (flag2 && flag3) {
	                        ...
	                        if (this.world.setBlockState(blockpos1, this.fallTile, 3)) {
	                              ((BlockCandleSlab)block).onEndFalling(this.world, blockpos1, this.fallTile, blockstate);
	                     ...
	                     {
	                    	((BlockCandleSlab)block).breakFall(this.world, blockpos1, this.fallTile, blockstate, this);
	                     }
	                  } else{
	                     ((BlockCandleSlab)block).onBroken(this.world, blockpos1);
	                  }
	               }
	            }
	         }
