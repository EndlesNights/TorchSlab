...
public class BlockFieryTorchSlab extends BlockTorchSlab implements IWaterLoggable
{
	...
	{
		return !(boolean)state.get(this.WATERLOGGED) && fluid == Fluids.WATER;
	}
    ...
    public void animateTick(BlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        ...
        worldIn.addParticle(ParticleRegistry.fiery_spark, false, d0 + offset0, d1 + offset1 -0.50D, d2 + offset2, 0F, 0F, 0F);
        worldIn.addParticle(ParticleRegistry.fiery_glow, false, d0 , d1 - 0.1D -0.50D, d2 , 0F, 0F, 0F);
    }
